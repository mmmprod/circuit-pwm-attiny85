/*
 * ═══════════════════════════════════════════════════════════════
 * CIRCUIT PWM µC V1.7.10 - ATtiny85
 * ═══════════════════════════════════════════════════════════════
 * 
 * Changements vs 1.7.8:
 *   - TIMEOUT READADC() : Cohérence avec readVCCmV() (protection bloqué)
 *   - HW_REVISION mise à jour pour V1.16 (R9 = 1kΩ critique)
 * 
 ...
 * 
 * Historique:
 *   V1.7.10: Timeout readADC() cohérent, HW_REVISION V1.16 (R9=1kΩ)
...
#define FW_DATE      "2025-12-09"
#define FW_AUTHOR    "mmmprod"
#define HW_REVISION  "V1.16"
